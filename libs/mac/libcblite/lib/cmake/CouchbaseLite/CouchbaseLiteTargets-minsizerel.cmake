...
set_target_properties(cblite PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libcblite.3.2.1.dylib"
  IMPORTED_SONAME_MINSIZEREL "@rpath/libcblite.3.dylib"
  )

list(APPEND _cmake_import_check_targets cblite )
list(APPEND _cmake_import_check_files_for_cblite "${_IMPORT_PREFIX}/lib/libcblite.3.2.1.dylib" )
