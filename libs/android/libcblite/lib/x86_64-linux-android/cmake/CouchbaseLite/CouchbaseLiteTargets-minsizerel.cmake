...
set_target_properties(cblite PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/x86_64-linux-android/libcblite.so"
  IMPORTED_SONAME_MINSIZEREL "libcblite.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS cblite )
list(APPEND _IMPORT_CHECK_FILES_FOR_cblite "${_IMPORT_PREFIX}/lib/x86_64-linux-android/libcblite.so" )
